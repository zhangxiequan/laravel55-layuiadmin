(function () {
    ...
    var gb = qa(window.GoogleAnalyticsObject) && sa(window.GoogleAnalyticsObject) || "ga", Ba = !1,
    ...
    var Qb = T("_oot"), dd = S("previewTask"), Rb = S("checkProtocolTask"), md = S("validationTask"),
        ...
        n = T("clientIdTime"), Ad = S("userId", "uid"), Na = T("trackingId", "tid"), U = T("cookieName", void 0, "_ga"),
        W = T("cookieDomain"), Yb = T("cookiePath", void 0, "/"), Zb = T("cookieExpires",
        void 0, 63072E3), $b = T("legacyCookieDomain"), Wc = T("legacyHistoryImport", void 0, !0),
        ...
        ec = T("alwaysSendReferrer", void 0, !1), I = T("_gid", "_gid"), ja = T("_ge"), la = T("_gcn"),
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/, pc = function (a) {
        ...
        a:if (c = a.get(cc), d = E(M.location[c ? "href" : "search"], "_ga"))if (a.get(bc))if (c = d.indexOf("."), -1 == c) J(22); else {
            var e = d.substring(0, c), g = d.substring(c + 1), c = g.indexOf("."), d = g.substring(0, c),
                g = g.substring(c + 1);
            if ("1" == e) {
