 ...
 * Generated for Laravel 5.5.45 on 2019-04-23 12:14:14.
 *
...
namespace Yansongda\LaravelPay\Facades { 
    ...
    class Pay {
         ...
         * @static 
         */ 
        public static function find($order, $refund = false, $transfer = false)
        {
            return \Yansongda\Pay\Gateways\Alipay::find($order, $refund, $transfer);
        }
